...
namespace EntityFrameworkCore.ExpressionSerializers.Concrete
{
    public class Layer0StatementSerializer : IRightUnionExpressionSerializer
    {
        ...
        private static string Union(UnionExpression exp) => $"SELECT {PropertiesSerializer.ColumnsUnion(exp.EntityType,"this")} FROM {exp.EntityType.Name} AS this {PropertiesSerializer.JoinsUnion(exp.EntityType,"this")}";
